...
class ClientImagesModel extends CI_Model {

    var $table = "ClientImages";
    var $key = "ClientImages_ID";

    function __construct() {
        parent::__construct();
        $this->data_db = $this->load->database('image', TRUE);
    }
    ...
    function delete_by_field($field, $val) {
        $this->data_db->trans_begin();
